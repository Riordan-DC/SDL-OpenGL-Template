/*
    ...
    OpenGL loader generated by glad 0.1.34 on Wed Aug 11 12:27:24 2021.
...
static int get_exts(void) {
    ...
    if(max_loaded_major < 3) {
        ...
        if (num_exts_i > 0 && exts_i == NULL) {
			size_t ext_con = sizeof(*exts_i);
			exts_i = (char**)malloc((size_t)num_exts_i * ext_con);
        }
